 ...
 * @date: 2021-08-27
 */
//class SmartViewHolder(itemView: View, var mListener: AdapterView.OnItemClickListener) :
...
class SmartViewHolder(itemView: View, var mKtListener: ((parent: AdapterView<*>?, view: View, position: Int, id: Long) -> Unit)) :
     ...
     * @return T
     */
    public fun findViewById(viewId: Int): View {
        return if (viewId == 0) itemView else itemView.findViewById(viewId)
    }
